...
export default function Home() {
  ...
  // 合作伙伴数据
  const partners = [
    { name: "CEM", logo: "https://via.placeholder.com/150x80?text=CEM" },
    { name: "Dometic", logo: "https://via.placeholder.com/150x80?text=Dometic" },
    { name: "Marco", logo: "https://via.placeholder.com/150x80?text=Marco" },
    { name: "NHK MEC", logo: "https://via.placeholder.com/150x80?text=NHK+MEC" },
    { name: "Sleipner", logo: "https://via.placeholder.com/150x80?text=Sleipner" },
    { name: "Seastar", logo: "https://via.placeholder.com/150x80?text=Seastar" },
    { name: "PYI", logo: "https://via.placeholder.com/150x80?text=PYI" },
    { name: "Polyform", logo: "https://via.placeholder.com/150x80?text=Polyform" },
    { name: "GUIDI", logo: "https://via.placeholder.com/150x80?text=GUIDI" },
    { name: "Honda", logo: "https://via.placeholder.com/150x80?text=Honda" },
  ];
